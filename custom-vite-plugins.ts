...
export function stripDevIcons (isDev: boolean) {
  ...
  return {
    ...
    renderStart (outputOptions: any, inputOptions: any) {
      ...
      fs.rm(resolve(outDir, 'icon-32.png'), () => console.log(`Deleted dev-icon-32.png from prod build`))
      fs.rm(resolve(outDir, 'icon-128.png'), () => console.log(`Deleted dev-icon-128.png from prod build`))
    }
  }
}
